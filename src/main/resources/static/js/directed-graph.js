...
class DirectedGraphVisualizer {
  ...
  async loadInitialData() {
    try {
      const response = await fetch("/data-structures/directed-graph/data")
  ...
  async addNode() {
    ...
    await this.performOperation("/data-structures/directed-graph/add-node", { value })
  }
  ...
  async addEdge() {
    ...
    await this.performOperation("/data-structures/directed-graph/add-edge", { fromId, toId, weight })
  }
